...
namespace NicoLiveAlertTwitterWPF.JSONClass
{
    //HTML解析してJSON取得する
    ...
    public class Account
    {
        ...
        public object prefecture { get; set; }
    ...
    public class AudienceLimitation
    {
        public string loginLimitation { get; set; }
    }
    ...
    public class Program
    {
        ...
        //public int timeshiftType { get; set; }
        public bool isTimeshiftButtonEnabled { get; set; }
        //public long timeshiftEndAt { get; set; }
        ...
        public bool showParticularAds { get; set; }
        public int particularAdsRotationIntervalSec { get; set; }
        public string ticketPurchaseUrl { get; set; }
        public bool isMemberOnly { get; set; }
        public bool viewChannelIcon { get; set; }
        public SocialGroup2 socialGroup { get; set; }
        ...
        public object elapsedTimeSeconds { get; set; }
        public object durationSeconds { get; set; }
        public SocialGroupDetail socialGroupDetail { get; set; }
        public AudienceLimitation audienceLimitation { get; set; }
        public object watchRestriction { get; set; }
    ...
    public class WatchInformation
    {
        ...
        public string watchingError { get; set; }
        public object deletedInfo { get; set; }
    ...
    public class Client
    {
        public List<object> __invalid_name__interceptors { get; set; }
        public List<object> __invalid_name__interceptor_providers { get; set; }
        public Channel4 __invalid_name__channel { get; set; }
    }
